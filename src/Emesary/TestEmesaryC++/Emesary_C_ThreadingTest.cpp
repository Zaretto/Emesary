...
namespace TestEmesaryC
{
	...
	public class TestThreadNotification : public Emesary::INotification
	{
	protected:
		void *value;
	public:
	...
	public class TestThreadRecipient : public Emesary::IReceiver
	{
	public:
		TestThreadRecipient() : InvocationCount(0)
		{
...
//	DWORD __stdcall  ThreadFunc(LPVOID lpThreadParameter)
	unsigned __stdcall  ThreadFunc(void *lpThreadParameter)
	{
		...
		TestThreadNotification tn(temp);
	...
	public: 
		...
		void Emesary_MultiThreadTransmitterTest()
		{
			...
			int v = nthread;
			Assert::AreEqual(num_threads, v);
			v = noperations;
			Assert::AreEqual(num_threads*MaxIterations, v);
			Assert::AreEqual(1, v);
		}
	};
}
